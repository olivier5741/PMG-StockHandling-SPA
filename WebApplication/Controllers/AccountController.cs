...
namespace WebApplication.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            {
                return BadRequest("Échec du nom de connexion externe.");
            }
            ...
            {
                return BadRequest("Le nom de connexion externe est déjà associé à un compte.");
            }
        ...
        private static class RandomOAuthStateGenerator
        {
            ...
            public static string Generate(int strengthInBits)
            {
                ...
                {
                    throw new ArgumentException("strengthInBits doit être divisible par 8.", "strengthInBits");
                }
